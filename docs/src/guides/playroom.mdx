...
The function setDefaultState sets the initial value for a key that can be retrieved with getState.
...
The function setState mutates the value for a key that can be retrieved with getState.
