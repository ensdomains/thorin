...
A generator script is available that will perform items 1 - 6 of [Adding Components](#adding-components). **Adding the component to the mododule export test must be done manually.** Access the script using:
