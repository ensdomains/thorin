...
const makeColorScheme = (mode: Mode = 'light') => {
  ...
  return {
    colors: {
      ...
      border: rgb(colors.foreground, shades.border),
      borderSecondary: rgb(colors.foreground, shades.borderSecondary),
      borderTertiary: rgb(colors.foreground, shades.borderTertiary),
      ...
      textPlaceholder: rgb(colors.foreground, shades.textPlaceholder),
